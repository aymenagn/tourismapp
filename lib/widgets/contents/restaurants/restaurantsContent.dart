                            ...
                            Container(
                              ...
                              /*Positioned(
                                ...
                                child: SizedBox(
                                    height: 200,
                                    child: Hero(
                                      tag:RestoList[index].image,
                                        child: Image.asset(RestoList[index].image))))*/
                              child: Column(
                                children: [
                                  Image.asset(
                                    //'assets/images/Resto_1.png',
                                    RestoList[index].image,
                                    height: 124,
                                    width: 197,
                                    fit: BoxFit.cover,
                                  ),
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            _buildBadge(
                                              //"10% OFF",
                                              RestoList[index].sold,
                                              background: Color(0xFF5D4CFF),
                                            ),
                                            SizedBox(width: 8),
                                            _buildBadge(
                                              //"⭐ 4.5",
                                              RestoList[index].rate,
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        onTap: () {
                          ...
                          //     builder:
                          //         (context) =>
                          //             HoteldetailScreen(RestoList2[index]),
                          //   ),
                          // );
                        },
                        child: Column(
                            ...
                            Container(
                              ...
                              /*Positioned(
                                ...
                                child: SizedBox(
                                    height: 200,
                                    child: Hero(
                                      tag:RestoList2[index].image,
                                        child: Image.asset(RestoList2[index].image))))*/
                              child: Column(
                                children: [
                                  Image.asset(
                                    //'assets/images/Resto_1.png',
                                    RestoList2[index].image,
                                    height: 124,
                                    width: 197,
                                    fit: BoxFit.cover,
                                  ),
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            _buildBadge(
                                              //"10% OFF",
                                              RestoList2[index].sold,
                                              background: Color(0xFF5D4CFF),
                                            ),
                                            SizedBox(width: 8),
                                            _buildBadge(
                                              //"⭐ 4.5",
                                              RestoList2[index].rate,
                                              background: Color(0xFF403571),
                                            ),
                                            Spacer(),
                                            IconButton(
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        onTap: () {
                          ...
                          //     builder:
                          //         (context) =>
                          //             HoteldetailScreen(RestoList3[index]),
                          //   ),
                          // );
                        },
                        child: Column(
                            ...
                            Container(
                              ...
                              /*Positioned(
                                ...
                                child: SizedBox(
                                    height: 200,
                                    child: Hero(
                                      tag:RestoList3[index].image,
                                        child: Image.asset(RestoList3[index].image))))*/
                              child: Column(
                                children: [
                                  Image.asset(
                                    //'assets/images/Resto_1.png',
                                    RestoList3[index].image,
                                    height: 124,
                                    width: 197,
                                    fit: BoxFit.cover,
                                  ),
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            _buildBadge(
                                              //"10% OFF",
                                              RestoList3[index].sold,
                                              background: Color(0xFF5D4CFF),
                                            ),
                                            SizedBox(width: 8),
                                            _buildBadge(
                                              //"⭐ 4.5",
                                              RestoList3[index].rate,
                                              background: Color(0xFF403571),
                                            ),
                                            Spacer(),
                                            IconButton(
